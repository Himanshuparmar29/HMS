                     ...
                     <div class="d-flex flex-wrap align-items-center justify-content-between">
                        <div class="d-flex flex-wrap align-items-center">
                           <div class="profile-img position-relative me-3 mb-3 mb-lg-0 profile-logo profile-logo1">
                              <img src="<?php echo"../my_php/".$row['img_path'];?>" alt="User-Profile" class="theme-color-default-img img-fluid rounded-pill avatar-100" loading="lazy">
                           </div>
                           <div class="d-flex flex-wrap align-items-center mb-3 mb-sm-0">
                              <h4 class="me-2 h4"><?php $username=$_SESSION["username"]; echo"$username";?></h4>
                              <span> - <?php echo $row['current_position']; ?></span>
                           </div>
                        </div>
                        <ul class="d-flex nav nav-pills mb-0 text-center profile-tab" data-toggle="slider-tab" id="profile-pills-tab" role="tablist">
                           ...
                           <li class="nav-item">
                              <a class="nav-link" data-bs-toggle="tab" href="#profile-profile" role="tab" aria-selected="true">Profile</a>
                           </li>
                        </ul>
                     </div>
                  </div>
               ...
               <div class="card-body">
                  <div class="d-grid gap-card grid-cols-3">
                     ...
                     <a data-fslightbox="gallery" href="../assets/images/shapes/03.png">
                        <img src="../assets/images/shapes/03.png" class="img-fluid bg-soft-warning rounded" alt="profile-image" loading="lazy">
                     </a>
                     ...
                     <a data-fslightbox="gallery" href="../assets/images/shapes/05.png">
                        <img src="../assets/images/shapes/05.png" class="img-fluid bg-soft-danger rounded" alt="profile-image" loading="lazy">
                     </a>
               ...
               <div class="card-body">
                  <div class="twit-feed">
                     <div class="d-flex align-items-center mb-2">
                        <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-soft-danger ps-2" src="../assets/images/avatars/03.png" alt="" loading="lazy">
                  ...
                  <div class="twit-feed">
                     <div class="d-flex align-items-center mb-2">
                        <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-soft-primary" src="../assets/images/avatars/04.png" alt="" loading="lazy">
                        <div class="media-support-info">
                  ...
                  <div class="twit-feed">
                     <div class="d-flex align-items-center mb-2">
                           <img class="rounded-pill img-fluid avatar-50 me-3 p-1 bg-soft-warning pt-2" src="../assets/images/avatars/02.png" alt="" loading="lazy">
                        <div class="mt-2">
          ...
          <div class="col-lg-3">
               ...
               <div class="card-body">
                  <ul class="list-inline m-0 p-0">
                     <li class="d-flex mb-4 align-items-center active">
                        <img src="../assets/images/shapes/02.png" alt="story-img" class="rounded-pill avatar-70 p-1 border bg-soft-light img-fluid" loading="lazy">
                        <div class="ms-3">
                           <h5>Web Design</h5>
                     ...
                     <li class="d-flex mb-4 align-items-center">
                        <img src="../assets/images/shapes/04.png" alt="story-img" class="rounded-pill avatar-70 p-1 border img-fluid bg-soft-danger" loading="lazy">
                        <div class="ms-3">
                           <h5>App Design</h5>
                     ...
                     <li class="d-flex align-items-center">
                        <img src="../assets/images/shapes/06.png" alt="story-img" class="rounded-pill avatar-70 p-1 border bg-soft-primary img-fluid" loading="lazy">
                        <div class="ms-3">
             ...
             <div class="card">
               ...
               <div class="card-body">
                  <ul class="list-inline m-0 p-0">
                     <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-warning rounded-pill"><img src="../assets/images/avatars/02.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Paul Molive</h6>
                     ...
                     <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-danger rounded-pill"><img src="../assets/images/avatars/03.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Robert Fox</h6>
                           <p class="mb-0">4 mutual friends</p>
                        </div>
                     ...
                     <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-dark rounded-pill"><img src="../assets/images/avatars/04.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Jenny Wilson</h6>
                     ...
                     <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-primary rounded-pill"><img src="../assets/images/avatars/05.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Cody Fisher</h6>
                     ...
                     <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-info rounded-pill"><img src="../assets/images/avatars/06.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Bessie Cooper</h6>
                     ...
                     <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-warning rounded-pill"><img src="../assets/images/avatars/07.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Wade Warren</h6>
                     ...
                     <li class="d-flex mb-4 align-items-center">
                        <div class="img-fluid bg-soft-success rounded-pill"><img src="../assets/images/avatars/08.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Guy Hawkins</h6>
                     ...
                     <li class="d-flex align-items-center">
                        <div class="img-fluid bg-soft-info rounded-pill"><img src="../assets/images/avatars/09.png" alt="story-img" class="rounded-pill avatar-40" loading="lazy"></div>
                        <div class="ms-3 flex-grow-1">
                           <h6>Floyd Miles</h6>
