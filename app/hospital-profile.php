...
<body class="  ">
            ...
            <div class="row">
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-wrap align-items-center justify-content-between">
                                ...
                                <ul class="d-flex nav nav-pills mb-0 text-center profile-tab" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" href="#profile-payment" role="tab"
                                            aria-selected="false">Operation Payments</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="profile-content tab-content iq-tab-fade-up">
                        <div id="profile-profile" class="tab-pane fade active show">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <a href="../operation/ope_request.php"><button type="button"
                                            class="btn btn-primary rounded-pill mt-2">Make Request</button></a>
                                </div>
                            </div>
                            <div class="card">
                                <div class="card-header">
                        ...
                        <div id="profile-activity" class="tab-pane fade">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    ...
                                    <div
                                        class="d-flex justify-content-between align-items-center rounded flex-wrap gap-3">
                                        <div class="form-group mb-3">
                                            <select class="select2-basic-single js-states form-control" name="state"
                                                id="state" style="width: 100%;">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive border rounded">
                                        ...
                                        <table id="operation-list-table" class="table table-striped" role="grid"
                                            ...
                                            <tbody>
                                                ...
                                                $sql1 = "SELECT * FROM operation join ope_doctor on operation.operation_id=ope_doctor.operation_id WHERE hospital_id='$username';";
                                                $result1 = mysqli_query($conn, $sql1);
                                                if ($result1) {
                                                    if (mysqli_num_rows($result1) > 0) {
                                                        while ($row1 = mysqli_fetch_assoc($result1)) {
                                                            ...
                                                            echo "<td>" . $row1['doctor_id'] . "</td>";
                                                            echo "<td>" . $row1['patient_id'] . "</td>";
                                                            echo "<td>" . $row1['date'] . "</td>";
                                                            echo "<td>" . $row1['status'] . "</td>";
                                                            echo "<td><a href='../operation/view_operation.php?operation_id=" . $row1["operation_id"] . "'><svg fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\">
                        ...
                        <div id="profile-payment" class="tab-pane fade">
                            <div class="card">
                                <div class="card-header d-flex justify-content-between">
                                    <div class="header-title">
                                        <h4 class="card-title">Operation List</h4>
                                ...
                                <div class="card-body">
                                    <div class="table-responsive border rounded">
                                        ...
                                        <table id="payment-list-table" class="table table-striped" role="grid"
                                            data-toggle="data-table">
                                            <thead>
                                                <tr class="ligth">
                                                    <th>Operation Id</th>
                                                ...
                                                if ($result1) {
                                                    if (mysqli_num_rows($result1) > 0) {
                                                        while ($row1 = mysqli_fetch_assoc($result1)) {
                                                            ...
                                                            echo "<td>" . $row1['doctor_id'] . "</td>";
                                                            echo "<td>" . $row1['patient_id'] . "</td>";
                                                            echo "<td>" . $row1['started_at'] . "</td>";
                                                            echo "<td>" . $row1['completed_at'] . "</td>";
    ...
    <script>
        $('#state').on('change', function () {
            ...
            $.ajax({
                url: '../my_php/get_operation_list_for_hospital.php',
                type: 'POST',
                data: { state: state_val },
                success: function (data) {
                    $('#operation-list-table').html(data);
                }
            });
        });
        $('#pay_state').on('change', function () {
            let state_val = $(this).val();
            $.ajax({
                url: '../my_php/get_payment_list_for_hospital.php',
                type: 'POST',
                data: { state: state_val },
                success: function (data) {
