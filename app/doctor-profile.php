...
$sql1 = "SELECT h.name as hospital_name,h.address,h.pincode,h.city,h.phone_number,h.hospital_id,doctor_id,Description,request_id,operation.operation_id as ope_id FROM ope_doctor join operation on ope_doctor.operation_id=operation.operation_id join hospital h on operation.hospital_id=h.hospital_id join ope_request on ope_request.requested_by=h.hospital_id where doctor_id='$username' and operation.status='pending'";
            ...
            <div class="row">
                            ...
                            <div class="d-flex flex-wrap align-items-center justify-content-between">
                                <div class="d-flex flex-wrap align-items-center">
                                    <div
                                        ...
                                        <img src="<?php echo "../my_php/" . $row['img_path']; ?>" alt="User-Profile"
                                            class="theme-color-default-img img-fluid rounded-pill avatar-100"
                                            loading="lazy">
                                    </div>
                                    <div class="d-flex flex-wrap align-items-center mb-3 mb-sm-0">
                                        <h4 class="me-2 h4"><?php
                                        echo $row['first_name'] . " " . $row['last_name']; ?></h4>
                                ...
                                <ul class="d-flex nav nav-pills mb-0 text-center profile-tab" data-toggle="slider-tab"
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active show" data-bs-toggle="tab" href="#profile-task"
                                            role="tab" aria-selected="false">New Task</a>
                                    </li>
                                    <li class="nav-item">
                ...
                <div class="col-lg-12">
                    <div class="profile-content tab-content iq-tab-fade-up">
                        <div id="profile-task" class="tab-pane fade active show">
                            <div class="col-lg-12">
                                <div class="card">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="text-center">
                                        <div>
                                            <img src="<?php echo "../my_php/" . $row['img_path']; ?>" alt="profile-img"
                                                class="rounded-pill avatar-130 img-fluid" loading="lazy">
                                        </div>
                                        <div class="mt-3">
                                            <h3 class="d-inline-block"><?php
                                            echo $row['first_name'] . " " . $row['last_name']; ?></h3>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-2">
                                        ...
                                        <p><?php echo $row["current_position"]; ?></p>
                                    </div>
                                    <div class="mt-2">
                                        <h6 class="mb-1">Years Of experience :</h6>
                                        <p><?php echo $row["years_of_experience"]; ?></p>
                                    </div>
                                    <div class="mt-2">
                                        <h6 class="mb-1">Active Status:</h6>
                                        <p><?php if ($row['is_active'] == "yes") {
                        ...
                        <div id="profile-activity" class="tab-pane fade">
                            <div class="card">
                                <div class="card-header">
                                    <div class="header-title">
                                        <h4 class="card-title">Ongoing Operation Details</h4>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <div class="custom-table-effect table-responsive  border rounded">
                                        <table id="user-list-table" class="table table-striped">
                                            <?php
                                            $sql2 = "SELECT h.name as hospital_name,h.address,h.pincode,h.city,h.phone_number,h.hospital_id,doctor_id,Description,request_id,operation.operation_id as ope_id FROM ope_doctor join operation on ope_doctor.operation_id=operation.operation_id join hospital h on operation.hospital_id=h.hospital_id join ope_request on ope_request.requested_by=h.hospital_id where doctor_id='$username' and operation.status='in-progress'";
                                            $result2 = mysqli_query($conn, $sql2);
                                            $row2 = mysqli_fetch_assoc($result2);
                                            if (!$row2 == null) {
                                                echo "<tr class=\"ligth\">";
                                                echo '<th scope="col">Hospital Name</th>';
                                                echo "<td>" . $row2['hospital_name'] . "</td>";
                                                echo "</tr>";
                                                echo "<tr class=\"dark\">";
                                                echo '<th scope="col">Operation Description</th>';
                                                ...
                                                echo "<td>" . $row2['address'] . "," . $row2['city'] . "," . $row2['pincode'] . "</td>";
                                                echo "</tr>";
                                                echo "<tr>";
                                                echo "<td colspan='2'><a href='../operation/end_of_operation.php?ope_id=" . $row2['ope_id'] . "'><button type='button' class='btn btn-primary'>Complete</button></td>";
                                                echo "</tr>";
                                            } else {
                                                echo "<tr class=\"ligth\">";
                                                echo "<td>No Ongoing Operations</td>";
                                                echo "</tr>";
                                            } ?>
                                        </table>
                                    </div>
                            ...
                            <div class="card card-block card-stretch card-height">
                                <div class="flex-wrap card-header d-flex justify-content-between border-0">
                                    <div class="header-title">
                                        <h4 class=" card-title">Completed Operations</h4>
                                    </div>
                                    <div class="dropdown">
                                ...
                                <div class="card-body pt-0">
                                    <div class=" table-responsive border rounded">
                                        <table class="table mb-0" id="datatable" data-toggle="data-table">
                                            ...
                                            <tbody>
                                                <?php
                                                $sql1 = "SELECT h.name as hospital_name,h.address,h.pincode,h.city,h.phone_number,h.hospital_id,doctor_id,Description,request_id,operation.operation_id as ope_id FROM ope_doctor join operation on ope_doctor.operation_id=operation.operation_id join hospital h on operation.hospital_id=h.hospital_id join ope_request on ope_request.requested_by=h.hospital_id where doctor_id='$username' and operation.status='completed'";
                                                $result1 = mysqli_query($conn, $sql1);
                                                while ($row1 = mysqli_fetch_assoc($result1)) {
                                                    echo "<tr>";
                                                    echo "<td>" . $row1['hospital_name'] . "</td>";
                                                    ...
                                                    echo "<td>" . $row1['phone_number'] . "</td>";
                                                    echo "<td>" . $row1['address'] . "," . $row1['city'] . "," . $row1['pincode'] . "</td>";
                                                    echo "<td><a href='../operation/view_completed_operation.php?request_id=" . $row1["request_id"] . "&operation_id=" . $row1["ope_id"] . "'><svg fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\">
