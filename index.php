...
$d_sql1 = "SELECT count(doctor_id) as d_count FROM doctor where is_active='yes';";
$result1 = mysqli_query($conn, $d_sql1);
$row1 = mysqli_fetch_assoc($result1);
$d_count = $row1["d_count"];
$h_sql = "SELECT count(hospital_id) as h_count FROM hospital where is_active='yes';";
$h_result = mysqli_query($conn, $h_sql);
$h_row = mysqli_fetch_assoc($h_result);
$h_count = $h_row["h_count"];

$ope_count_sql = "SELECT count(operation_id) as ope_count FROM operation where status='completed';";
$ope_count_result = mysqli_query($conn, $ope_count_sql);
$ope_count_row = mysqli_fetch_assoc($ope_count_result);
$ope_count = $ope_count_row["ope_count"];

$avai_doc_sql = "SELECT count(doctor_id) as active_doc FROM doctor where is_available='yes';";
$avai_doc_result = mysqli_query($conn, $avai_doc_sql);
$avai_doc_row = mysqli_fetch_assoc($avai_doc_result);
$avai_doc = $avai_doc_row["active_doc"];

$active_ope_sql="SELECT count(operation_id) as active_ope FROM operation where status='in-progress';";
$active_ope_result = mysqli_query($conn, $active_ope_sql);
$active_ope_row = mysqli_fetch_assoc($active_ope_result);
$active_ope = $active_ope_row["active_ope"];

$pending_ope_sql="SELECT count(operation_id) as pending_ope FROM operation where status='pending';";
$pending_ope_result = mysqli_query($conn, $pending_ope_sql);
$pending_ope_row = mysqli_fetch_assoc($pending_ope_result);
$pending_ope = $pending_ope_row["pending_ope"];
?>
<!doctype html>
...
<body class="  ">
                    ...
                    <div class="row">
                        <div class="col-lg-2 col-md-6">
                            <div class="card text-center">
                                <div class="card-body">
                                    <h2 class="mb-3"><?php echo $d_count;
                                    ?></h2>
                                    <a href="app/doctor-list.php"><h5>Doctors</h5></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-6">
                            <div class="card text-center">
                                <div class="card-body">
                                    <h2 class="mb-3"><?php echo $avai_doc;
                                    ?></h2>
                                    <a href="app/doctor-list.php"><h5>Available Doctors</h5></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-6">
                            <div class="card text-center">
                                <div class="card-body">
                                    <h2 class="mb-3"><?php echo $h_count;
                                    ?></h2>
                                    <a href="app/hospital-list.php"><h5>Hospitals</h5></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="card text-center">
                                <div class="card-body">
                                    <h2 class="mb-3"><?php echo $active_ope;
                                    ?></h2>
                                    <a href="app/operation-list.php?state=in-progress"><h5>Total Ongoing Operations</h5></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="card text-center">
                                <div class="card-body">
                                    <h2 class="mb-3"><?php echo $pending_ope;
                                    ?></h2>
                                    <a href="app/operation-list.php?state=pending"><h5>Total Pending Operations</h5></a>
                                </div>
                            </div>
                        </div>
                ...
                <div class="d-flex justify-content-between align-items-center flex-wrap mb-5 gap-3">
                    <div class="d-flex justify-content-between align-items-center rounded flex-wrap gap-3">
                        <div class="form-group mb-0">
                            <select class="select2-basic-single js-states form-control" name="state" id="state"
                                style="width: 100%;">
                ...
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-md-6">
                            <div class="card text-center">
                                <div class="card-body">
                                    <h2 class="mb-3" id="doctor_visit"><?php echo $active_ope;
                                    ?></h2>
                                    <a href="app/doctor-list.php"><h5>Doctors Visit</h5></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="card text-center">
                                <div class="card-body">
                                    <h2 class="mb-3" id="com_ope"><?php echo $ope_count;
                                    ?></h2>
                                    <a href="app/operation-list.php?state=sompleted"><h5>Total Completed Operation</h5></a>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                                    ...
                                    <tbody>
                                        ...
                                        if (mysqli_num_rows($result) > 0) {
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<td><a href='operation/view.php?request_id=" . $row["request_id"] . "&hospital_id=" . $row["hospital_id"] . "'><svg fill=\"none\" xmlns=\"http://www.w3.org/2000/svg\" width=\"24\" height=\"24\" viewBox=\"0 0 24 24\">
    ...
    <script>
        $('#state').on('change',function(){
            ...
            function getDoct(){
                $.ajax({
                    url :'my_php/get_doctor.php',
                    type :'POST',
                    data : {state:opt},
                    success : function(data){
                        $('#doctor_visit').html(data);
                    }
                });
            }
            getDoct();
