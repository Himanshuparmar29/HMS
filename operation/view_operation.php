                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <div class="header-title">
                                    <h4 class="card-title">Operation Information:</h4>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="table-responsive border rounded">
                                    ...
                                    $sql1 = "SELECT * FROM operation WHERE operation_id='$operation_id'";
                                    $result1 = mysqli_query($conn, $sql1);
                                    $row1 = mysqli_fetch_assoc($result1);

                                    $sql2="SELECT * FROM operation join ope_doctor on operation.operation_id=ope_doctor.operation_id join doctor on ope_doctor.doctor_id=doctor.doctor_id where operation.operation_id='$operation_id'";
                                    $result2 = mysqli_query($conn, $sql2);
                                    $row2 = mysqli_fetch_assoc($result2);

                                    $sql3="SELECT * from operation join patients on operation.patient_id=patients.patient_id where operation.operation_id='$operation_id'";
                                    ...
                                    <table id="user-list-table" class="table table-striped">
                                        <tr class="ligth">
                                            ...
                                            <td><?php echo $row1['hospital_id']; ?></td>
                                        </tr>
                                        <tr class="dark">
                                        ...
                                        <tr class="dark">
                                            <th>Medications : </th>
                                            <td><?php echo $row3['medications']; ?></td>
                                        </tr>
                                        <tr class="ligth">
                                            <th>Allergies : </th>
                                            <td><?php echo $row3['allergies']; ?></td>
                                        </tr>
                                        <tr class="dark">
                                            <th>Medical History : </th>
                                            <td><?php echo $row3['medical_history']; ?></td>
                                        </tr>
                                        <tr class="light">
                                            <th>Symptoms : </th>
                                            <td><?php echo $row3['symptoms']; ?></td>
                                        </tr>
                                        <?php 
                                        if($row1['status']=='completed')
                                        {
                                            $sql4="SELECT amount from operation join payment on operation.operation_id=payment.operation_id where operation.operation_id='$operation_id'";
                                            ...
                                            <td>".$row1['started_at']."</td>
                                            </tr>
                                            <tr class=\"dark\">
                                            <th>Operation Completed At: </th>
                                            <td>".$row4['completed_at']."</td>
                                            </tr>
                                            <tr class=\"light\">
                                            <th>payment: </th>
                                            <td>".$row4['status']."</td>
